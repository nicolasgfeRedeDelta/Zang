    ...
    <div className={classes.root}>
      ...
      >
        <div className={classes.toolbarIcon}>
          <img src={logo} style={{ margin: "0", height: "45px", width: "100%" }} alt="logo" />
          <div style={{display: "flex", position: "absolute", backgroundColor: "#005CFF", height: "45px", justifyContent: "flex-end", right: 0 }}>
